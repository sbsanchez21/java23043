			...
			<div class="d-flex justify-content-center">
				<form action="../controller/addUsuario.jsp" method="post">
	                ...
	                <div class="input-group mb-3">
	                    <input type="password" name="pass" id="pass" onkeyup="validarPass()" class="form-control" placeholder="Constraseña" aria-label="Username" aria-describedby="basic-addon1">
	                ...
	                <div class="input-group mb-3">
	                    <input type="password" id="repPass" name="repPass" onkeyup="compararPass()" class="form-control" placeholder="Constraseña" aria-label="Username" aria-describedby="basic-addon1">
	                    <span class="input-group-text" id="basic-addon1">
	                        <a href="#">
