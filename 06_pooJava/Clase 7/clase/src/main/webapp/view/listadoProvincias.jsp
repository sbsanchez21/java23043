...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		<div class="text-center fs-3 my-4">Listado Provincias</div>
		...
		<table class="table table-striped text-center">
		  ...
		  <tbody>
			...
			while(rs.next()) {
				...
				out.println("<td>");
				out.println(rs.getInt("idprovincia"));
				out.println("</td>");
				...
				out.println("<td>");
				out.println("<a href='udpProvincia.jsp?id="+rs.getInt("idprovincia")+"'><i class='bi bi-pencil-fill m-1'></i></a>");
